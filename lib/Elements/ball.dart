...
//    });
  ...
  void initAction() {
    acceleration.add(Vector2.random());
  }
  ...
  void render(Canvas c) {
    ...
    c.drawCircle(Offset(0, 0), .2, paint);
    c.restore();
  }
  ...
  void update(double t) {
    ...
    if (!over &&
        !game.screenRect.overlaps(Rect.fromLTWH(body.position.x * finalScale, body.position.y * finalScale, .2, .2))) {
